  ...
  class: [
    {
      ...
      items: [
        ...
        {
          name: 'Колонка JBL PartyBox 1000 Вт.',
          price: '2 000 ₽',
        },
        {
    ...
    },
    {
      ...
      gallery: [{ src: folgaImage, alt: 'Фольгированное шоу' }],
    },
    {
      title: 'С Шоу "Сладкая Вата"',
      duration: '≈ 90 минут',
      price: '14 500 ₽',
      items: [
        { name: 'Дед Мороз и Снегурочка', price: '8 000 ₽' },
      ...
      gallery: [{ src: vata1, alt: 'Шоу Сладкая Вата' }],
    },
  ],
  yard: [
    {
